// Copied from NativeWebSocket https://github.com/endel/NativeWebSocket
// Licence Apache 2.0
...
// Third party code modified, does not follow project rules
    ...
    public class WebSocket : IWebSocket {
        ...
        public async Task Connect() {
            try {
                ...
                m_Socket.Options.KeepAliveInterval = TimeSpan.FromSeconds(15);
